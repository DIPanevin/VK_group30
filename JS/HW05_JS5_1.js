...
for (firstName in users) {
    if ((users[firstName].registrationDate == '09.10.2021') || (users[firstName].registrationDate == '10.10.2021'))
        console.log(users[firstName].firstName + ' зарегистрирован ' + users[firstName].registrationDate);
}
